...
- (void)addAllChildVc {
    ...
    [self addOneChildVC:home title:@"首页" imageName:@"bottom_home_icon@3x" selectedImageName:@"bottom_home_icon_on@3x"];
    
    MatchViewController *customer = [[MatchViewController alloc] init];
    [self addOneChildVC:customer title:@"搭配" imageName:@"bottom_dapei_icon@3x" selectedImageName:@"bottom_dapei_icon_on@3x"];
   //R customer.view.backgroundColor = Global_mainBackgroundColor;
    
    CommunityViewController *community = [[CommunityViewController alloc] init];
    [self addOneChildVC:community title:@"社区" imageName:@"bottom_bbs_icon@3x" selectedImageName:@"bottom_bbs_icon_on@3x"];
    community.view.backgroundColor = Global_mainBackgroundColor;
    
    ShoopingCarVC *shopCar = [[ShoopingCarVC alloc] init];
    [self addOneChildVC:shopCar title:@"购物车" imageName:@"bottom_shopping_icon@3x" selectedImageName:@"bottom_shopping_icon_on@3x"];
    shopCar.view.backgroundColor = Global_mainBackgroundColor;
    
    MyselfVC *myvc = [[MyselfVC alloc]init];
    [self addOneChildVC:myvc title:@"我的" imageName:@"bottom_like_icon@3x" selectedImageName:@"bottom_like_icon_on@3x"];
    myvc.view.backgroundColor = Global_mainBackgroundColor;
